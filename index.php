        ...
        <div id="large-header" class="large-header">
            ...
            <nav id="main-nav">
                ...
                <ul class="unstyled-list anchors">
                    <div id="nav">
                        <nav>
                            <li><a class="navbara" href="#header" class="aactive">Home</a>
                            </li>
                            ...
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="post" action="subscribe.php">
                                        <div class="col-md-8">
                                            <input type="email" required autocomplete="off" placeholder="Your Email address*" onfocus="this.placeholder = '';" onblur="if (this.placeholder == '') {this.placeholder = 'Your Email address*';}" class="form-control emailinpform" name="email" required></input>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="submit" value="Subscribe" class="form-control"></input>
                                        </div>
                                    </form>
                                </div>
                ...
                <div id="aboutus" class="yellow wrapper spied target">
                    ...
                    <div class="wrapper grey">
                        <section id="calendar" class="spied scrollable target">
                            ...
                            <!--To add or modify events, modify: defcss1.css 1219, 600 myjs.js -->
                            <div class="list upable eveupdiv">
                                <h3>2016</h3>
                                <ul class="unstyled-list">
                                    <li class="clearfix" id="eveliid0" data-toggle="collapse" data-target="#evecol0">
                                        <div class="date">11 August 2016 </div>
                                        <div class="place">Competitive Programming - <span> All you need to know. </span> </div> <i class="fa events3dots"></i> </li>
                                        <div class="evecol collapse" id="evecol0">
                                            <br>
                                            <div class="text-center"> <a href="http://bit.ly/acmvit_event" target="_blank"><button class="btn btn-primary text-center">Register now</button></a></div>
                                            <div class="comptextdiv"> <p>ACM VIT is excited to introduce you to an engineer's sport - competitive programming! Entering the World of Competitive Programming will ease you into this new world, and give you a basic grasp of the concepts of competitive programming and the way to go about it.</p>
                                                ...
                                                <p class="leftsuretext">What is Competitive programming?<br>
                                                    Why Competitive Programming?<br>
                                                    Small Success story. (Adam D'Angelo CEO: Quora)<br>
                                                    Basics and Getting Started:<br>
                                                    &nbsp;&nbsp; C++ Standard Template Libraries<br>
                                                    &nbsp;&nbsp;Cracking the time limit errors.<br>
                                                    &nbsp;&nbsp;Categories of questions asked: Ad Hoc, Greedy algorithms, Dynamic Programming<br>
                                                </p>
                                            </div>
                                        ...
                                        <li class="clearfix" id="eveliid1" data-toggle="collapse" data-target="#evecol1">
                                            ...
                                            <li class="clearfix" id="eveliid2" data-toggle="collapse" data-target="#evecol2">
                                                ...
                                                <div class="place">#IteratePython - <span> Basic and advanced python workshop. </span> </div> <i class="fa events3dots"></i> </li>
                                                ...
                                                <li class="clearfix" id="eveliid3" data-toggle="collapse" data-target="#evecol3">
                                                    ...
                                                    <div class="place">Codart - <span> A bunch of unique coding and dart challenges. </span> </div> <i class="fa events3dots"></i> </li>
