...
<head>
	...
	<title>ACM-VIT Student's chapter</title>
	<meta name="description" content="We are ACM International's official student chapter in VIT-Vellore promoting new and upcoming computing concepts within the student community." />
	<meta name="keywords" content="ACM VIT, chapter, tech, technical, web designing, harshit kedia,harshitkedia32@gmail.com">
	<meta name="author" content="ACM VIT, harshit kedia,harshitkedia32@gmail.com">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta property="og:type" content="website" />
	<meta property="og:site_name" content="ACM VIT" />
	<meta property="og:url" content="acmvit.com" />
	<meta property="og:title" content="ACM VIT Student's chapter" />
	<meta property="og:description" content="We are ACM International's official student chapter in VIT-Vellore promoting new and upcoming computing concepts within the student community." />
	<meta property="og:image" content="http://acmvit.com/images/ourlogo2.png" />
	<meta itemprop="name" content="ACM VIT" />
	<meta itemprop="description" content="We are ACM International's official student chapter in VIT-Vellore promoting new and upcoming computing concepts within the student community." />
	<meta itemprop="image" content="images/favicon.ico" />
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:site" content="@acmvit" />
	<meta name="twitter:title" content="ACM VIT Student's chapter" />
	<meta name="twitter:description" content="We are ACM International's official student chapter in VIT-Vellore promoting new and upcoming computing concepts within the student community." />
	...
	<link rel="stylesheet" href="css/defcss1.css">
	<link rel="stylesheet" type="text/css" href="css/card.css">
	<link rel="stylesheet" type="text/css" href="css/achi.css">
...
<body>
	<!--[if lt IE 9]> <p class="browserupgrade">your brower is<strong>obsolete</strong>. please <a target="_blank" href="http://browsehappy.com/">update your browser</a> for better experience.</p> <![endif]-->
	<div id="myDiv" class="animate-bottom">
		<div id="large-header" class="large-header">
			<div id="particles">
				<section id="header" class="spied target">
					<header>
						<div class="head-elem-wrap">
							<h1><img src="images/logowhite.png" id="mainacmlogo" alt="ACM VIT"></h1>
							<p class="helping">Helping Technology grow since 2009.</p>
							<br>
							<br class="hiddeninsmall">
							<br class="hiddeninsmall">
							<h2 class="headvit">VIT University Student Chapter</h2> </div>
						</header>
						<div class="slider">
							<nav class="mobile"> </nav>
							<!--[if lte IE 9]> <button class="nav prev"></button> <![endif]-->
							<!--[if gt IE 9]><!-->
							<paper-button class="nav prev"></paper-button>
							<!--<![endif]-->
							<!--[if lte IE 9]> <button class="nav next"></button> <![endif]-->
							<!--[if gt IE 9]><!-->
							<paper-button class="nav next"></paper-button>
							<!--<![endif]-->
							<ul class="unstyled-list" id="anim"> </ul>
						</div>
					</section>
				</div>
			</div>
			<nav id="main-nav">
				<button type="button" class="menu"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
				<button type="button" class="close"></button>
				<ul class="unstyled-list anchors">
					<div id="nav">
						<nav>
							<li><a class="navbara" href="#header">Home</a>
							</li>
							<li><a class="navbara" href="#aboutus">About us</a>
							</li>
							<li><a class="navbara" href="#calendar">Events</a>
							</li>
							<li><a class="navbara" href="#achievements">Achievements</a>
							</li>
							<li><a class="navbara" href="#yellow">The Board</a>
							</li>
							<li><a class="navbara" href="#photo">Gallery</a>
							</li>
							<li><a class="navbara" href="#contactus">Contact us</a>
							</li>
						</nav>
					</div>
				</ul>
				<ul class="unstyled-list social">
					<li style="display:none;"><a target="_blank" href="https://googleplus.com/" class="gitclass google"><span class=" navgit12">Github</span></a>
					</li>
					<li><a target="_blank" class="facebook" href="http://facebook.com/ACM.VITU">Facebook</a>
					</li>
					<li><a target="_blank" class="twitter" href="http://twitter.com/ACMVITU">Twitter</a>
					</li>
				</ul>
				<!--[if lte IE 9]> <button class="signin">Participer</button> <![endif]-->
				<!--[if gt IE 9]><!-->
				<button class="signin" data-toggle="modal" data-target="#myModal">Subscribe</button>
				<!-- Modal -->
				<div id="myModal" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							<div class="modal-header">
								<h1 class="modal-title">Subscribe</h1> </div>
								<div class="modal-body">
									<h3>Subscribe to be the first to receive updates on all our upcoming events, workshops, and any other juicy details!</h3>
									<form method="post" action="contact.php">
										<div class="col-md-8">
											<input type="email" autocomplete="off" placeholder="Your Email address*" onfocus="this.placeholder = '';" onblur="if (this.placeholder == '') {this.placeholder = 'Your Email address*';}" class="form-control emailinpform" name="email" required>
										</div>
										<div class="col-md-4">
											<input type="submit" name="subscribe_submit" value="Subscribe" class="form-control">
										</div>
									</form>
								</div>
					...
					<!--<![endif]-->
					<ul class="unstyled-list where"> </ul>
				</nav>
				<div id="aboutus" class="yellow wrapper spied target">
					...
					<div class="wrapper grey">
						<section id="calendar" class="spied scrollable target">
							<header class="">
								<h2>Events</h2>
								<p>All our events are full of fun and guaranteed to be fantastic learning experiences.</p>
							</header>
							<!--To add or modify events, modify: defcss1.css 1219:
									#eveliidm2,
									#eveliidm1,
									#eveliid0,
							...
							, 600:
									...
									<div class="list upable eveupdiv">
										...
										<ul class="unstyled-list">
											...
											<div class="evecol collapse" id="evecolm2">
												<br>
												<div class="text-center"> <a href="https://goo.gl/Hxqo6T" target="_blank"><button class="btn btn-primary text-center">Register</button></a></div>
												<div class="comptextdiv"> <p class="down-no-margin">Natural language processing is a computer's ability to interpret human speech. It has created a bond between human and machine like never before. Computers are no longer just machines- they have become irreplaceable companions of the human race, blending into the human environment as easily as any natural element. This seamless transition was made possible with the induction of NLP into the technological world.
													Come and explore the whole new world of possibilities with ACM VIT's "Talk The Future Tech", an opportunity like never before.</p>
													<a href="https://www.facebook.com/events/346209232379182/" target="_blank">Facebook event page</a><br>
												</div>
												<h4 class="text-center">Photos of the event</h4>
												<iframe src="html/eventm2.html"></iframe>
											</div>
											<li class="clearfix" id="eveliidm1" data-toggle="collapse" data-target="#evecolm1">
												<div class="date">17 September 2016 </div>
												<div class="place">Google App Engine - <span> Python and GAE. </span> </div> <i class="fa events3dots"></i> 
											</li>
											<div class="evecol collapse" id="evecolm1">
												<br>
												<div class="comptextdiv"> <p>The workshop was divided in two parts. First part covered the basics of python, which included operators, lists, tuples, dictionaries, modules and file handling. The participants where then taught how to use urllib2, and shown the uses of JavaScript Object Notation (JSON). In the second part, they were then introduced to Google App Engine, and shown the benefits of GAE. Along with that, they were shown how to deploy the app on a Google developer console, with a unique URL.</p>
												</div>
												<h4 class="text-center">Photos of the event</h4>
												<iframe src="html/eventm1.html"></iframe>
											</div>
											<li class="clearfix" id="eveliid0" data-toggle="collapse" data-target="#evecol0">
												<div class="date">17 September 2016 </div>
												<div class="place">Competitive Programming - <span> All you need to know. </span> </div> <i class="fa events3dots"></i> 
											</li>
											<div class="evecol collapse" id="evecol0">
												<br>
												<div class="text-center"> <a href="http://bit.ly/acmvit_event" target="_blank"><button class="btn btn-primary text-center">Register</button></a></div>
												<div class="comptextdiv"> <p>ACM VIT is excited to introduce you to an engineer's sport - competitive programming! Entering the World of Competitive Programming will ease you into this new world, and give you a basic grasp of the concepts of competitive programming and the way to go about it.</p>
												</div>
												<h4 class="text-center">Photos of the event</h4>
												<iframe src="html/event0.html"></iframe>
											</div>
											<li class="clearfix" id="eveliid1" data-toggle="collapse" data-target="#evecol1">
												<div class="date"> 17 March 2016 </div>
												<div class="place">TechJAM - <span> Apple vs FBI Encryption debate. </span> </div> <i class="fa events3dots"></i> </li>
												<div class="evecol collapse" id="evecol1">
													<p>ACM presents an opportunity to all technical freaks, gadget gurus and debate lovers, voice your opinion on technical issues raging across the world. The topic for this debate was Apple vs FBI Encryption dispute. We all know strong encryption has it's costs, but are the risks of weakening it potentially much worse?</p>
													<h4 class="text-center">Photos of the event</h4>
													<iframe src="html/event1.html"></iframe>
												</div>
												<li class="clearfix" id="eveliid2" data-toggle="collapse" data-target="#evecol2">
													<div class="date"> 04 March 2016 </div>
													<div class="place">#IteratePython - <span> Basic and advanced python workshop. </span> </div> <i class="fa events3dots"></i> 
												</li>
												<div class="evecol collapse" id="evecol2">
													<p>ACM conducted a free series of workshop called #IteratePython. The basics of python programming language were taught in this session. The session includes the basic introduction to python and the scope of python in future tech world.The Basic Python ,Data structures and intricacies of indentation were studied next. String manipulation programs and built in string functions were explained. File handling was briefly brushed upon. The session ended with a small introduction to beautifulsoup.py which is used for scraping any website’s entire resources!</p>
													<h4 class="text-center">Photos of the event</h4>
													<iframe src="html/event2.html"></iframe>
												</div>
												<li class="clearfix" id="eveliid3" data-toggle="collapse" data-target="#evecol3">
													<div class="date"> 26 January 2016 </div>
													<div class="place">Codart - <span> A bunch of unique coding and dart challenges. </span> </div> <i class="fa events3dots"></i> 
												</li>
												<div class="evecol collapse" id="evecol3">
													<p>Codart was a technical competition conducted by ACM VIT, which brings you a bunch of unique coding challenges. The event was divided into two rounds. The first round was conducted online. The coding bonanza incorporates a number of unique levels like the Volatile Round, Rush Hour and Slip N Tweet. This round will be tricky, fast-paced and spans a period of 36 hours. The second round allows players to asses some of their other skills as well. Players must burst balloons that contain coding problems with darts. The better the skill of the player, the more valuable the question they skewer.</p>
													<h4 class="text-center">Photos of the event</h4>
													<iframe src="html/event3.html"></iframe>
												</div>
											</ul>
										</div>
										<div class="list upable eveupdiv">
											<h3>2015</h3>
											<ul class="unstyled-list">
												<li class="clearfix" id="eveliid4" data-toggle="collapse" data-target="#evecol4">
													<div class="date"> 26 September 2015 </div>
													<div class="place">Big Data - <span> Big Data and Hadoop configuration. </span>
													</div> <i class="fa events3dots"></i> </li>
													<div class="evecol collapse" id="evecol4">
														<p>This workshop started with the basics of big data, and discussed the working, merits and demerits. It then covered the Hadoop configuration and the general design of the Hadoop infrastructure. The participants were instructed in the use of Cloudera, and Hadoop ecosystem.</p>
														<h4 class="text-center">Photos of the event</h4>
														<iframe src="html/event4.html"></iframe>
													</div>
													<li class="clearfix" id="eveliid5" data-toggle="collapse" data-target="#evecol5">
														<div class="date"> 25 September 2015 </div>
														<div class="place">Google App Engine - <span> Python, JSON, and Google App Engine. </span>
														</div> <i class="fa events3dots"></i> </li>
														<div class="evecol collapse" id="evecol5">
													...
													<section id="cd-timeline" class="cd-container">
														...
														<div class="cd-timeline-block" id="showless">
															...
															<div class="cd-timeline-content">
																...
																<p>I got into ACM in my first year, after I went to their session on Cloud Computing. I liked it a lot, and followed up on the chapter. Soon I became a member of ACM, and later a core committee member. I got to interact with awesome club members- Kuldeep Singh, Arjun Kapur, Ruchir Patwa to name a few. All in all, ACM VIT was an awesome experience - one that I proudly recall from my college life.</p> <span class="cd-date">2011-12, <i>Design Head</i></span> 
															</div>
															<!-- cd-timeline-content -->
														</div>
														<div class="cd-timeline-block" id="showless">
															...
															<div class="cd-timeline-content">
																...
																<p>I joined ACM VIT in my first semester of college and the experience was overwhelming. I learnt a lot from my seniors. I was the organiser of events during graVITas and the responsibility taught me event management. In my third year, I was elected as the treasurer. That was a brilliant experience too. I now work as a developer Oracle in Bangalore.</p> <span class="cd-date">2013-14, <i>Treasurer</i></span> 
															</div>
															<!-- cd-timeline-content -->
														</div>
													...
													<div class="card">
														<div id="show5">
															...
															<div class="card-content">
																...
																<h4><b>Deputy Technical Head</b></h4>
															</div>
													...
													<div class="card">
														<div id="show8">
															...
															<div class="card-content">
																...
																<h4><b>Marketing & Design Head</b></h4> 
															</div>
													...
													<div class="card">
														<div id="show9">
															...
															<div class="card-content">
																...
																<h4><b>University Relations</b></h4> 
															</div>
													...
													<div class="card">
														<div id="show10">
															...
															<div class="card-content">
																...
																<h4><b>Membership Coordinator</b></h4>
															</div>
											...
											<div class="formdiv">
												<form method="post" action="contact.php" class="">
													...
													<div class="text-field-subject col-md-12">
														<input type="text" title="Subject" autocomplete="off" name="subject" placeholder="Subject" onfocus="this.placeholder = '';" onblur="if (this.placeholder == '') {this.placeholder = 'Subject';}"> 
													</div>
								...
								<script type="text/javascript">
									...
									{
										if($_SESSION['contact_success']=='send')
											echo "alert('Thank you for contacting us. We will get back to you soon');";
										if($_SESSION['contact_success']=='fail')
											echo "alert('Some Error Occurred. Please try emailing or calling us')";
										$_SESSION['contact_success']='none';
									}
									if(isset($_SESSION['subscribe_success']))
									{
										if($_SESSION['subscribe_success']=='send')
											echo "alert('Thank you for subscribing us. We will get back to you soon');";
										if($_SESSION['subscribe_success']=='fail')
											echo "alert('Some Error Occurred. Please try emailing or calling us');";
